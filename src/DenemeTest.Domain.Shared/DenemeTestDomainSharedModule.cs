...
public class DenemeTestDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        DenemeTestGlobalFeatureConfigurator.Configure();
        DenemeTestModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<DenemeTestDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<DenemeTestResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/DenemeTest");

            options.DefaultResourceType = typeof(DenemeTestResource);
        ...
        {
            options.MapCodeNamespace("DenemeTest", typeof(DenemeTestResource));
        });
    }
}
