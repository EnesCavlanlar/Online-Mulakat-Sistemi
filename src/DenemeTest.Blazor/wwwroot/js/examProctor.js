window.examProctor = (function () {
    ...
    function visibilityHandler() {
        if (document.visibilityState === 'hidden' && dotnet) {
    ...
    window.mediaGate = (function () {
        ...
        return { request, attachPreview, stop, getStream };
    })();
    ...
    return {
        ...
        dispose: function () {
            ...
            // tüm medya izni & preview temizle
            try { window.mediaGate.stop(); } catch { }
        }
    };
})();
